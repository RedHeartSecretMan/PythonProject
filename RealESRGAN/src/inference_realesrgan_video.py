...
def run(args):
    ...
    num_process = num_gpus * args.num_process_per_gpu + 1
    if num_process == 1:
...
def main():
    """Inference demo for RealESRGAN.
    It mainly for restoring anime videos.

    """
    parser = argparse.ArgumentParser()
    parser.add_argument('-i', '--input', type=str, default='video_inputs/onepiece_demo.mp4', help='Input video, image or folder')
    parser.add_argument(
        '-n',
        '--model_name',
        type=str,
