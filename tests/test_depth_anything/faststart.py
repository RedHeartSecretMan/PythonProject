...
sys.path.append(
    os.path.abspath(
        os.path.join(
            os.path.dirname(__file__), os.pardir, os.pardir, "Depth-Anything-V2"
        )
    )
)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--outdir", type=str, default="./results/vis_video_depth")
    ...
    depth_anything.load_state_dict(
        torch.load(
            f"./stores/checkpoints/depth_anything_v2_{args.encoder}.pth",
            map_location="cpu",
        )
    )
